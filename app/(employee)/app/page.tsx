              ...
              <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4, delay: 0.15 }} className="lg:col-span-4">
                <div className="card-elevated p-4 h-full">
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    {[
                      { href: "/app/history", icon: Clock, label: "History", color: "text-blue-500 bg-blue-500/10" },
                      { href: "/app/leave", icon: Palmtree, label: "Leave / PTO", color: "text-emerald-500 bg-emerald-500/10" },
                      { href: "/app/callouts", icon: Phone, label: "Callouts", color: "text-amber-500 bg-amber-500/10" },
                      { href: "/app/reports", icon: BarChart3, label: "Reports", color: "text-purple-500 bg-purple-500/10" },
                    ].map((link) => (
                      <Link
                        key={link.href}
                        href={link.href}
