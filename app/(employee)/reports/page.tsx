...
export default function ReportsPage() {
  ...
  return (
    ...
    >
      <PageHeader
        title="Reports"
        subtitle="Your time & compliance stats"
        actions={
      ...
      <div className="px-4 pt-4 pb-2 max-w-6xl mx-auto lg:px-8">
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
          ...
          <Card className="border-0 shadow-lg rounded-2xl text-center p-4">
            ...
            <p className="text-xs text-muted-foreground">Compliant Weeks</p>
          </Card>
        </div>
      </div>
...
<style>body{font-family:-apple-system,sans-serif;max-width:800px;margin:40px auto;padding:0 20px}h1{color:#2563EB;border-bottom:3px solid #2563EB;padding-bottom:8px}table{width:100%;border-collapse:collapse;margin:20px 0}th,td{padding:8px 12px;text-align:left;border-bottom:1px solid #eee}th{background:#f5f5f5;font-weight:600}.summary{display:grid;grid-template-columns:repeat(4,1fr);gap:16px;margin:20px 0}.stat{background:#f8f9fa;border-radius:8px;padding:16px;text-align:center}.stat-value{font-size:24px;font-weight:700;color:#2563EB}.stat-label{font-size:12px;color:#666;margin-top:4px}@media print{body{margin:0}}</style></head><body>
<h1>KPR Time Report</h1>
...
<p style="color:#666;font-size:12px;margin-top:40px;">Generated by KPR Time Tracker</p>
