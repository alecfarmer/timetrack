...
-- Example: UPDATE "Location" SET "userId" = 'abc123-def456-...' WHERE "userId" IS NULL;

-- UPDATE "Location" SET "userId" = 'YOUR_USER_ID_HERE' WHERE "userId" IS NULL;
...
-- 6. After backfill, make userId NOT NULL
...
-- 8. Update WorkDay unique constraint to include userId
